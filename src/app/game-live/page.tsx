          ...
          <div className="flex-1 p-3 flex flex-col overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto space-y-1 flex-1 w-full overflow-hidden">
              {scoreRankings.map((player, index) => (
                ...
                >
                  {/* 排名 */}
                  <div className={`w-11 h-11 rounded-full flex items-center justify-center font-bold text-xl flex-shrink-0 ${index === 0 ? 'bg-yellow-500 text-black' :
                  ...
                  {player.avatar_url ? (
                    ...
                    <div className="w-11 h-11 bg-white bg-opacity-30 rounded-full flex items-center justify-center text-black font-bold text-lg flex-shrink-0">
              ...
              {scoreRankings.length === 0 && (
                <div className="text-center text-black text-lg opacity-60 py-3">
                  暫無排行榜資料
                </div>
              )}
            </div>
                            ...
                            <div className="relative z-10 flex flex-col h-full p-3">
                              ...
                              <div className="flex-1 flex flex-col justify-start overflow-hidden">
                                {distribution && distribution.users && distribution.users.length > 0 ? (
                                  ...
                                  <div className="text-center text-white opacity-60 text-xs">
                                    暫無人選擇
                                  </div>
                                )}
                              </div>
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col h-full p-4">
                            ...
                            <div className="flex items-center flex-shrink-0 mb-3">
                              {/* 左側：ABCD 標號 */}
                              <div className="text-xl md:text-3xl font-black text-white mr-4 w-16 text-center flex-shrink-0">
                                {option.key}
                              </div>
                              {/* 右側：答案敘述 */}
                            ...
                            <div className="flex-1 flex flex-col justify-start overflow-hidden">
                              {distribution && distribution.users && distribution.users.length > 0 ? (
                                ...
                                <div className="text-center text-white opacity-60">
                                  <div className="text-sm">暫無人選擇</div>
                                </div>
                              )}
                            </div>
    ...
    <div className="h-screen w-screen p-4 overflow-hidden">
      <div className="w-full h-full max-w-[1600px] mx-auto flex flex-col">
        ...
        <div className="mb-3 flex-shrink-0">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-1 text-center">
            快問快答
          </h1>
          <p className="text-lg md:text-xl text-white opacity-90 text-center">
            掃描 QR Code 加入遊戲
          </p>
        </div>
        ...
        <div className="flex-1 flex gap-4 min-h-0">
          {/* 左側：玩家列表 */}
          <div className="flex-1 bg-white bg-opacity-10 backdrop-blur-md rounded-2xl p-3 flex flex-col min-h-0">
            <div className="flex items-center justify-center space-x-2 mb-3 flex-shrink-0">
            ...
            <div className="flex-1 min-h-0 overflow-hidden">
              {joinedPlayers.length > 0 ? (
                ...
                <div className="text-black text-lg opacity-60 py-4 text-center">
                  等待玩家加入...
                </div>
              )}
            </div>
          ...
          {/* 右側：QR Code */}
          <div className="w-[320px] bg-white bg-opacity-10 backdrop-blur-md rounded-2xl p-2 flex flex-col items-center">
            <QrCode className="w-8 h-8 text-white mb-1" />
            <h3 className="text-lg md:text-xl font-bold text-black mb-1">掃描加入遊戲</h3>
            <div className="w-[280px] aspect-square bg-white rounded-2xl flex items-center justify-center shadow-2xl p-2">
              <img
                src="/line2dcode.png"
                alt="QR Code"
        ...
        {/* 底部區域：遊戲計分規則 + menu2-2 */}
        <div className="mt-3 flex gap-4 flex-shrink-0">
          {/* 左側：遊戲計分規則 - 和玩家列表同寬 */}
          <div className="flex-1 bg-white bg-opacity-20 backdrop-blur-md rounded-2xl p-3">
            ...
            <div className="grid grid-cols-2 gap-3 text-black">
              <div className="bg-white bg-opacity-30 rounded-lg p-3 text-center">
                ...
                <div className="text-lg md:text-xl font-bold mb-1">參與答題</div>
                <div className="text-xl md:text-2xl font-black text-blue-600 mb-1">50 分基本分</div>
                <div className="text-sm md:text-base opacity-90">只要有參與答題就會有基本分！</div>
              </div>
              <div className="bg-white bg-opacity-30 rounded-lg p-3 text-center">
                <div className="text-3xl mb-1">✅</div>
                <div className="text-lg md:text-xl font-bold mb-1">答對獎勵</div>
                <div className="text-xl md:text-2xl font-black text-green-600 mb-1">額外 1~50 分</div>
          ...
          {/* 右側：menu2-2 圖片 */}
          <div className="w-[360px] bg-white bg-opacity-10 backdrop-blur-md rounded-2xl p-3 flex items-center justify-center">
            <img
              src="/menu2-2.jpg"
              alt="Menu"
