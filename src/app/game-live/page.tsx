  ...
  return (
    <div className="min-h-screen h-screen overflow-hidden bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      ...
      {gameState?.display_phase === 'rankings' ? (
        <div className={`h-screen flex flex-col ${(gameState?.completed_questions || 0) >= (gameState?.total_questions || 0)
          ...
          <div className="flex-1 p-8">
            <div className="text-center mb-8">
              <h2 className="text-4xl md:text-6xl font-bold text-white mb-4">
                {(gameState?.completed_questions || 0) >= (gameState?.total_questions || 0)
                  ? '🎉 最終排行榜 🎉'
                  : '🏆 目前排行榜'}
              </h2>
